        ...
        <div class="container mx-auto">
            ...
            <div class="animate-fade-in flex items-stretch justify-center lg:space-x-4" x-show="isReady" x-cloak>
                ...
                <div class="flex w-full max-w-3xl flex-col items-center justify-start px-2 xl:px-0">
                    ...
                    <x-card class="w-full" x-ref="postCard">
                        <article>
                            {{-- post title --}}
                            <h1 class="dark:text-lividus-500 dark:from-lividus-800/60 -mx-4 -mt-4 rounded-t-xl bg-linear-to-r from-emerald-100/60 to-transparent px-4 py-6 text-2xl leading-relaxed font-semibold text-emerald-600 md:text-4xl">
                                {{ $post->title }}
                            </h1>

                            {{-- post thumbnail --}}
                            @if (! empty($post->cover_image_url))
                                <div class="-mx-4" id="post-cover-image">
                                    <img class="w-full" src="{{ $post->cover_image_url }}" alt="{{ $post->title }}" />
                                </div>
                            @endif
                            ...
                            {{-- post body --}}
                            <div class="rich-text mt-4" x-ref="postBody">{!! $post->body !!}</div>
                        </article>
                    </x-card>
                    ...
                    <x-card class="mt-6 grid w-full grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 space-y-2 md:col-span-10">
                            <div class="text-zinc-400 uppercase">written by</div>
                            <a
