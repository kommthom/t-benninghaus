    ...
    <div class="container mx-auto grow">
        <div class="flex flex-col items-start justify-center gap-6 px-4 md:flex-row">
            ...
            <x-card class="flex w-full flex-col justify-center gap-6 md:max-w-2xl">
                ...
                <x-quotes.success> {{ __('After registering a Passkey, you will no longer be able to log in with a password') }} </x-quotes.success>

                <form id="passkey" x-on:submit.prevent="register">
                    <x-floating-label-input id="name" type="text" placeholder="{{ __('Passkey Name') }}" x-model="name" />
                </form>
