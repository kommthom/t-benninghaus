...
<search x-data="globalSearchPart">
    ...
    >
        ...
        <span class="transition duration-300 dark:group-hover:text-zinc-50 group-hover:text-zinc-900">{{ __('Search') }}</span>
                ...
                <div class="flex justify-center items-end p-4 min-h-full text-center sm:items-start sm:p-0">
                    ...
                    >
                        ...
                        @if (strlen($search) >= 2)
                            ...
                            >
                                @if ($results->count() > 0)
                                    <div class="flex justify-center items-center">{{ __('Search Results') }}</div>
