...
it('calculates read time for Chinese only content', function () {
    $chineseContent = str_repeat('中', 250); // 250 Chinese characters
...
it('calculates read time for mixed English and Chinese content', function () {
    $mixedContent = str_repeat('word ', 100).str_repeat('中', 125); // 100 English words + 125 Chinese chars

    // 100/200 + 125/250 = 0.5 + 0.5 = 1 minute
