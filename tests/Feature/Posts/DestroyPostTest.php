...
describe('destroy post', function () {
    test('author can soft delete own post in desktop show post page', function () {
        ...
        Livewire::test('posts.desktop-menu', [
            ...
            ->assertDispatched('toast', status: 'success', message: 'Successfully deleted post!')
    ...
    test('author can soft delete own post in user information post card', function () {
        ...
        Livewire::test('users.group-posts-by-year', [
            ...
            ->call('destroy', $post->id)
            ->assertDispatched('toast', status: 'success', message: 'Article deleted');
    ...
    test('author can restore deleted post', function () {
        ...
        Livewire::test('users.group-posts-by-year', [
            ...
            ->assertDispatched('toast', status: 'success', message: 'Article has been restored');
